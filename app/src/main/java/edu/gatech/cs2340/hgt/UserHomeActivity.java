...
public class UserHomeActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newesalebtn  = (Button)rootView.findViewById(R.id.friend_detail_unfriendBtn);
        setValues();
        return rootView;
    }
    ...
    private void setValues() {
        ...
        newesalebtn.setOnClickListener(new UnFriendListener(b.getString("currentUser")
